...
export default function FeaturesAndFlashSale() {
  ...
  return (
    <div className="bg-slate-950 text-white relative overflow-hidden">
      ...
      {/* 5. FLASH SALE BANNER */}
      <section className="py-16 container mx-auto px-6 mb-16 relative z-10">
        <div className="relative rounded-3xl p-8 sm:p-12 overflow-hidden bg-gradient-to-r from-purple-900/40 via-slate-900 to-indigo-900/40 border border-purple-500/30 flex flex-col md:flex-row items-center justify-between gap-8 shadow-2xl backdrop-blur-md">
          
          <div className="absolute -right-20 -bottom-20 w-64 h-64 bg-pink-500/10 rounded-full blur-3xl pointer-events-none" />

          <div className="relative z-10 max-w-xl text-center md:text-left">
            <span className="px-3.5 py-1 rounded-full text-xs font-extrabold uppercase bg-pink-500/20 text-pink-300 border border-pink-500/30">
              Flash Sale Hari Ini
            </span>
