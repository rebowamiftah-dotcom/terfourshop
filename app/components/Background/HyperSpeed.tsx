  ...
  constructor(container: HTMLElement, options: HyperspeedOptions) {
    ...
    if (gl && typeof gl.getContextAttributes === 'function') {
      ...
      gl.getContextAttributes = function () {
        ...
        return attrs ?? { alpha: true, depth: true, stencil: true, antialias: false, premultipliedAlpha: true, preserveDrawingBuffer: false, powerPreference: 'default', failIfMajorPerformanceCaveat: false };
      } as unknown as typeof gl.getContextAttributes;
    }
